...
public class NapsAdapterRight extends BaseAdapter {
    private String[] napsArray;
    private Context superActivityContext;
    private LayoutInflater layoutInflater;
    private DisplayMetrics displayMetrics;

    public NapsAdapterRight(MainActivity mainActivity, String[] napsArray) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        rowView.setBackgroundResource(R.drawable.rect_bg_right);
